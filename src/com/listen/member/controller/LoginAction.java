...
public class LoginAction extends BaseController {
	...
	public String login(HttpServletRequest request, HttpSession session) {
		...
		if(EmailList.size()!=0 && pass.equals(password))
		{
			...
			session.setAttribute("adminYn", memberVo.getAdmin_yn());
	...
	public String memberInfo(HttpServletRequest request, HttpSession session)
	{
		...
		System.out.println(id + email + gender + password + birthyear);
	...
	@RequestMapping("/mLogin.listen") //모바일 로그인 첫페이지
