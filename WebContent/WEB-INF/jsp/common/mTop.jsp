...
<nav class="navbar navbar-inverse">
 ...
 %>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/mView.listen"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></a></li>
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <% 	
            	if (session.getAttribute("LoginYn") != null && ((String) session.getAttribute("LoginYn")).length() > 0
					...
					{  
			%>
            			<li><a href="mLogout.listen"><span class="glyphicon glyphicon-send" aria-hidden="true"> 로그아웃</a></li>
            <% 	
            		} 
            %>
            <li class="divider"></li>
